...
export const GAMES_CONFIG = {
  "원신": {
    ...
    defaultImg: "./assets/default_genshin.webp",
  ...
  "붕괴: 스타레일": {
    ...
    defaultImg: "./assets/default_starrail.webp",
  ...
  "젠레스 존 제로": {
    ...
    defaultImg: "./assets/default_zzz.webp",
  ...
  "명조": {
    ...
    defaultImg: "./assets/default_wuthering.webp",
    icon: "./assets/icon_wuthering.webp",
  ...
  "명일방주: 엔드필드": {
    ...
    defaultImg: "./assets/default_endfield.webp",
    icon: "./assets/icon_endfield.webp",

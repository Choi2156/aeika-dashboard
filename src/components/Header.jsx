 ...
 * 우측에 '애이카 아카이브' 유튜브 구독 홍보 연동 배너가 추가되었습니다.
 */
export default function Header() {
  return (
    <header className="header">
      <div className="header__title-group">
        <h1 className="header__title">서브컬처 게임 일정 대시보드</h1>
      ...
      <div className="header__youtube-promo">
        <span className="youtube-promo__text">다양한 서브컬처 게임 소식과 쇼츠는</span>
        <a
